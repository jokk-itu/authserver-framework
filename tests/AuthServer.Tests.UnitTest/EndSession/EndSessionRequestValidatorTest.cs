...
public class EndSessionRequestValidatorTest : BaseUnitTest
{
    ...
    [Fact]
    public async Task Validate_InvalidIdTokenHint_ExpectInvalidIdToken()
    {
        // Arrange
    ...
    [Fact]
    public async Task Validate_MismatchingClientIdFromIdTokenHintAndClientId_ExpectInvalidIdToken()
    {
        // Arrange
        var endSessionUserAccessor = new Mock<IUserAccessor<EndSessionUser>>();
        var endSessionUser = new EndSessionUser("subject", true);
    ...
    public async Task Validate_ValidIdTokenHintWithPostLogoutRedirectUri_ExpectEndSessionValidatedRequest()
    {
        ...
        // Assert
        Assert.True(processResult.IsSuccess);
        Assert.Equal(subjectIdentifier.Id, processResult.Value!.SubjectIdentifier);
