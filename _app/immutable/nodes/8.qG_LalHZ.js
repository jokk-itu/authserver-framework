import{f as c,a as o,t as f}from"../chunks/BHF9wNqu.js";import"../chunks/CU9afjlv.js";import{p as H,f as p,a as J,e as O,s as i,$ as B,n as h}from"../chunks/DL6eumzt.js";import{h as W}from"../chunks/DMOXgEdX.js";import{i as D}from"../chunks/DQgLNG-F.js";import{C as m}from"../chunks/DbZgjyKz.js";import{I}from"../chunks/CuMYCe1t.js";import{P as V,S as l}from"../chunks/C3UgRdqy.js";import{T as y,R as e}from"../chunks/4YLJMDwf.js";var j=c(`<p>The client can authenticate itself when requesting endpoints, through a
        ...
        public key cryptography.</p>`,1),z=c("<p>Authenticate using the HTTP Authorization header, using the basic schema.</p> <p>The header contains the client id as the username and the client secret as the password.</p> <p>The combination of client id and secret is afterwards base64 encoded.</p> <p>The following example is for the token endpoint. The client id is s6BhdRkqt3 and the client secret is gX1fBat3bV.</p> <!>",1),N=c("<p>Authenticate using the HTTP body. The body contains the client id and the client secret.</p> <p>The following example is for the token endpoint.</p> <!>",1),F=c(`<p>The client secret must be shared between the client and AuthServer for client secret JWT to work.
            AuthServer does not support this, because secrets are hashed.</p>`),K=c("<p>Authenticate using the HTTP body. The body contains the client assertion type, the client assertion and optionally the client id.</p> <p>The token must be signed, and can optionally be encrypted.</p> <p>The following example is for the token endpoint.</p> <!> <p>The following table describes the possible claims in the token.</p> <!>",1),X=c("<!> <!> <!> <!> <!> <!> <!>",1);function te(P,A){H(A,!1);let C=["Name","Description"],S=[[new e("OAuth2.1","https://datatracker.ietf.org/doc/draft-ietf-oauth-v2-1/"),new e("Core specification for OAuth")],[new e("OpenId Connect","https://openid.net/specs/openid-connect-core-1_0.html"),new e("Core specification for OpenId Connect")],[new e("JWT Assertion framework","https://datatracker.ietf.org/doc/rfc7523/"),new e("Specification for JWT assertions")],[new e("Assertion framework","https://datatracker.ietf.org/doc/rfc7521/"),new e("Specification for OAuth assertions")]],x=["Name","Description"],R=[[new e("iss"),new e("Required. Issuer of the token, must be the client id")],[new e("sub"),new e("Required. Subject of the token, must be the client id")],[new e("aud"),new e("Required. Audience of the token, must be the endpoint where the client is authenticating")],[new e("jti"),new e("Required. Unique id of the token")],[new e("exp"),new e("Required. Expiration time of the token")],[new e("iat"),new e("Optional. Time at which the token was issued")],[new e("typ"),new e("Required. Type of token, which must be: pk+jwt")]];D();var w=X();W("1emw62s",t=>{O(()=>{B.title="Client Authentication"})});var $=p(w);V($,{title:"Client Authentication"});var T=i($,2);l(T,{title:"Introduction",children:(t,d)=>{var n=j();h(2),o(t,n)},$$slots:{default:!0}});var _=i(T,2);l(_,{title:"Specifications",children:(t,d)=>{y(t,{title:"Specifications",tableNumber:1,get headers(){return C},get rowCellDefinitions(){return S}})},$$slots:{default:!0}});var g=i(_,2);l(g,{title:"Client Secret Basic",children:(t,d)=>{var n=z(),r=i(p(n),8);m(r,{children:(a,u)=>{h();var s=f();s.nodeValue=`
POST /token HTTP/1.1
...
client_assertion=eyJ0eXAiOiJKV1QiLCJh...82U
        `,o(u,b)},$$slots:{default:!0}});var a=i(r,4);y(a,{title:"Private key JWT claims",tableNumber:2,get headers(){return x},get rowCellDefinitions(){return R}}),o(t,n)},$$slots:{default:!0}}),o(P,w),J()}export{te as component};
