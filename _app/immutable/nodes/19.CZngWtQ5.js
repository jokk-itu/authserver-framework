import{f as v,a as e,t as p}from"../chunks/BHF9wNqu.js";import"../chunks/CU9afjlv.js";import{c as E,r as z,f,e as O,s as n,$ as U,n as a}from"../chunks/DL6eumzt.js";import{h as B}from"../chunks/DMOXgEdX.js";import{C as h}from"../chunks/DbZgjyKz.js";import{I as R}from"../chunks/CuMYCe1t.js";import{P as G,S as g}from"../chunks/C3UgRdqy.js";import{s as M}from"../chunks/BqRdp-zL.js";var N=v('<div class="p-4 my-2 rounded-lg bg-orange-700 font-medium text-amber-200"><!></div>');function V(y,C){var A=N(),$=E(A);M($,C,"default",{}),z(A),e(y,A)}var q=v(`<p>The following sections describe how to setup AuthServer framework in
        ...
        then take a look at the MVP setup in <a href="https://github.com/jokk-itu/authserver-framework/tree/main/src/AuthServer.TestIdentityProvider">AuthServer.TestIdentityProvider</a>.</p>`),W=v(`<p>The JwksDocument is responsible for defining keys for signing and
        ...
        For example, to require authentication for POST in the register endpoint.</p> <!>`,1),H=v(`<p>The modules in AuthServer are built to be dynamically turned on or off
        during runtime. This is handled through the library
        Microsoft.FeatureManagement.</p> <!>`,1),L=v(`<p>Some tables can grow very large over time, and it is therefore important to cleanup rows that cannot be used anymore.
...
`,e(r,u)},$$slots:{default:!0}}),e(o,t)},$$slots:{default:!0}});var k=n(T,2);g(k,{title:"Feature management",children:(o,m)=>{var t=H(),s=n(f(t),2);h(s,{children:(d,c)=>{a();var i=p();i.nodeValue=`
...
`,e(d,i)},$$slots:{default:!0}}),e(o,t)},$$slots:{default:!0}});var I=n(k,2);g(I,{title:"Automatic cleanup",children:(o,m)=>{var t=L(),s=n(f(t),2);h(s,{children:(d,c)=>{a();var i=p();i.nodeValue=`
// Inside Program.cs
using AuthServer.Options;
