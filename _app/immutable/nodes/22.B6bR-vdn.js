import{f as r,a as n,t as x}from"../chunks/BHF9wNqu.js";import"../chunks/CU9afjlv.js";import{p as z,f as b,a as D,e as F,s as o,$ as E,n as i}from"../chunks/DL6eumzt.js";import{h as O}from"../chunks/DMOXgEdX.js";import{i as A}from"../chunks/DQgLNG-F.js";import{C as T}from"../chunks/DbZgjyKz.js";import{P as H,S as a}from"../chunks/C3UgRdqy.js";import{T as R,R as y}from"../chunks/4YLJMDwf.js";var J=r(`<p>The token exchange grant type is used to exchange a token for another one.
        ...
        The keys of the client requesting the token exchange, will be used to encrypt the token.</p>`),W=r("<!> <!> <!> <!> <!> <!> <!> <!> <!> <!>",1);function oe(w,P){z(P,!1);let q=["Name","Description"],I=[[new y("Token Exchange","https://datatracker.ietf.org/doc/html/rfc8693"),new y("Specification to exchange tokens")]];A();var d=W();O("a19h53",e=>{F(()=>{E.title="Token Exchange"})});var h=b(d);H(h,{title:"Token Exchange"});var l=o(h,2);a(l,{title:"Introduction",children:(e,s)=>{var t=J();i(8),n(e,t)},$$slots:{default:!0}});var u=o(l,2);a(u,{title:"Specifications",children:(e,s)=>{R(e,{title:"Specifications",tableNumber:1,get headers(){return q},get rowCellDefinitions(){return I}})},$$slots:{default:!0}});var k=o(u,2);a(k,{title:"Restrictions and Extensions",children:(e,s)=>{var t=N();i(10),n(e,t)},$$slots:{default:!0}});var f=o(k,2);a(f,{title:"Token endpoint",children:(e,s)=>{var t=V(),v=o(b(t),6);T(v,{children:(p,j)=>{i();var c=x();c.nodeValue=`
