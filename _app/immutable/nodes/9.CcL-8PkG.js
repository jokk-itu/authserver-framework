...
&resource=https%3A%2F%2Fapi-two.protectedresource.dk
        `,o(a,r)},$$slots:{default:!0}});var w=t(m,4);k(w,{children:(a,D)=>{$();var r=g();r.nodeValue=`
HTTP/1.1 200 OK
...

{
  ...
  "scope": "account:update account:delete"
        ...
        `,o(a,r)},$$slots:{default:!0}});var _=t(w,4);c(_,{title:"Request parameters",tableNumber:2,get headers(){return P},get rowCellDefinitions(){return x}});var A=t(_,4);c(A,{title:"Response parameters",tableNumber:3,get headers(){return y},get rowCellDefinitions(){return R}}),o(n,s)},$$slots:{default:!0}}),o(v,p),F()}export{E as component};
