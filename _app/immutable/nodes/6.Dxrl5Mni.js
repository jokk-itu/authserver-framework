import{t as i,h as T,a as s}from"../chunks/BdD32qd5.js";import"../chunks/BOyCDzPS.js";import{f as u,$ as _,s as a,c as g,n,r as m}from"../chunks/Db0b_LWK.js";import{a as v}from"../chunks/CANx_FtO.js";import{P as I,S as o}from"../chunks/DcIxqC40.js";import{b as $}from"../chunks/CQRN7NoZ.js";var P=i("<p>The AuthServer framework has been built as a single NuGet package.</p>"),w=i(`<p>Endpoints have been designed as a minimum HTTP handler, with an accessor
        ...
        for faster retrieval of data.</p>`),k=i("<!> <!> <!> <!> <!>",1);function F(q){var h=k();T(t=>{_.title="Software architecture page of AuthServer"});var c=u(h);I(c,{title:"Architecture"});var f=a(c,2);o(f,{title:"Introduction",children:(t,l)=>{var e=P();s(t,e)},$$slots:{default:!0}});var p=a(f,2);o(p,{title:"Endpoints",children:(t,l)=>{var e=w(),r=a(u(e),4),d=g(r);v(d,"src",`${$??""}/endpoint-architecture.png`),n(2),m(r),n(4),s(t,e)},$$slots:{default:!0}});var b=a(p,2);o(b,{title:"Modules",children:(t,l)=>{var e=x(),r=a(u(e),4),d=g(r);v(d,"src",`${$??""}/module-architecture.png`),n(2),m(r),n(4),s(t,e)},$$slots:{default:!0}});var y=a(b,2);o(y,{title:"Cache",children:(t,l)=>{var e=S();s(t,e)},$$slots:{default:!0}}),s(q,h)}export{F as component};
