import{f as i,a as s}from"../chunks/BHF9wNqu.js";import"../chunks/CU9afjlv.js";import{f as h,e as T,$ as I,s as r,c as g,n,r as m,t as v}from"../chunks/DL6eumzt.js";import{h as P}from"../chunks/DMOXgEdX.js";import{a as $}from"../chunks/BqRdp-zL.js";import{P as k,S as o}from"../chunks/C3UgRdqy.js";import{b as q}from"../chunks/DjK__fpz.js";var w=i("<p>The AuthServer framework has been built as a single NuGet package.</p>"),x=i(`<p>Endpoints have been designed as a minimum HTTP handler, with an accessor
        ...
        responsible for handling the request by using <b>IRequestHandler</b> and <b>IRequestAccessor</b>.</p>`,1),S=i(`<p>The AuthServer framework consists of a single csharp project, containing
        ...
        to make sure metadata about disabled features is not exposed.</p>`,1),A=i(`<p>The <b>Client</b> and related data is accessed in almost every request,
        ...
        for faster retrieval of data.</p>`),C=i("<!> <!> <!> <!> <!>",1);function j(_){var u=C();P("yk6gk9",t=>{T(()=>{I.title="Software Architecture in AuthServer"})});var c=h(u);k(c,{title:"Architecture"});var f=r(c,2);o(f,{title:"Introduction",children:(t,l)=>{var e=w();s(t,e)},$$slots:{default:!0}});var p=r(f,2);o(p,{title:"Endpoints",children:(t,l)=>{var e=x(),a=r(h(e),4),d=g(a);n(2),m(a),n(4),v(()=>$(d,"src",`${q??""}/endpoint-architecture.png`)),s(t,e)},$$slots:{default:!0}});var b=r(p,2);o(b,{title:"Modules",children:(t,l)=>{var e=S(),a=r(h(e),4),d=g(a);n(2),m(a),n(4),v(()=>$(d,"src",`${q??""}/module-architecture.png`)),s(t,e)},$$slots:{default:!0}});var y=r(b,2);o(y,{title:"Cache",children:(t,l)=>{var e=A();s(t,e)},$$slots:{default:!0}}),s(_,u)}export{j as component};
