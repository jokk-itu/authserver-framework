import{f as p,a as r,t as d}from"../chunks/Z1HRfbhX.js";import"../chunks/BQYPTkyu.js";import{f as m,e as R,s as o,$ as k,n as u}from"../chunks/Iw8VLsBB.js";import{h as P}from"../chunks/BhNhnXGn.js";import{C as l}from"../chunks/CVzv1ABR.js";import{P as w,S as c}from"../chunks/D5cW4fPA.js";var x=p(`<p>The following sections describe how to setup AuthServer framework in
        ...
        Microsoft.FeatureManagement.</p> <!>`,1),O=p(`<p>Some tables can grow very large over time, and it is therefore important to cleanup rows that cannot be used anymore.
        ...
        These services can be configured using the following options fields.</p> <!>`,1),U=p(`<p>The interface IDistributedCache in namespace AuthServer.Cache.Abstractions must be implemented.
        ...
        Its purpose is to return a AuthenticationContextReference from an AuthenticationMethodReference.</p>`,1),D=p(`<p>The following example shows how to add services for AuthServer, and how
        ...
        in the Scope table.</p> <!>`,1),V=p("<!> <!> <!> <!> <!> <!> <!> <!>",1);function W(y){var f=V();P("qwvjmj",i=>{R(()=>{k.title="IdentityProvider setup overview"})});var S=m(f);w(S,{title:"Setup"});var A=o(S,2);c(A,{title:"Introduction",children:(i,h)=>{var t=x();r(i,t)},$$slots:{default:!0}});var $=o(A,2);c($,{title:"Options",children:(i,h)=>{var t=E(),s=o(m(t),2);l(s,{children:(e,g)=>{u();var n=d();n.nodeValue=`
            // Inside Program.cs
        ...
        `,r(a,e)},$$slots:{default:!0}}),r(i,t)},$$slots:{default:!0}});var T=o(b,2);c(T,{title:"Automatic cleanup",children:(i,h)=>{var t=O(),s=o(m(t),2);l(s,{children:(a,v)=>{u();var e=d();e.nodeValue=`
            // Inside Program.cs
            using AuthServer.Options;
        ...
        `,r(a,e)},$$slots:{default:!0}}),r(i,t)},$$slots:{default:!0}});var I=o(T,2);c(I,{title:"Interfaces",children:(i,h)=>{var t=U();u(6),r(i,t)},$$slots:{default:!0}});var C=o(I,2);c(C,{title:"Startup",children:(i,h)=>{var t=D(),s=o(m(t),2);l(s,{children:(a,v)=>{u();var e=d();e.nodeValue=`
            // Inside Program.cs
            var builder = WebApplication.CreateBuilder(args);
