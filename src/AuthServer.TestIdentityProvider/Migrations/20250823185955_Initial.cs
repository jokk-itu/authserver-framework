    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RawValue = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    ...
                    LatestPoll = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CurrentInterval = table.Column<int>(type: "int", nullable: true),
                    DeviceCodeGrantId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    RevokedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Code_AuthorizationGrant_AuthorizationCodeGrantId",
                        column: x => x.AuthorizationCodeGrantId,
                        principalTable: "AuthorizationGrant",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Code_AuthorizationGrant_DeviceCodeGrantId",
                        column: x => x.DeviceCodeGrantId,
                        principalTable: "AuthorizationGrant",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserCode_Code_DeviceCodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Code_AuthorizationCodeGrantId",
                table: "Code",
                column: "AuthorizationCodeGrantId");

            migrationBuilder.CreateIndex(
                name: "IX_Code_DeviceCodeGrantId",
                table: "Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCode_DeviceCodeId",
                table: "UserCode",
                column: "DeviceCodeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserCode_Value",
                table: "UserCode",
                column: "Value");
        }
